...
! =============================================================================
!
! DAEDALUS2 is an open-source software, which allows scientists to build and
...
subroutine Print_Summary(prob, geom, mesh, dna)
    ...
    write(p_redir, "(a)"), " | DAEDALUS2 generated output files.                 |"
    write(p_redir, "(a)"), " +===================================================+"
...
subroutine Verify_Solution(prob, mesh, dna)
    ...
    write(0, "(a)"), "    3.10852914322950E+03 - Ref.:  1-1"
    write(0, "(a)"), "    3.27751572728029E+03 - Ref.: 11-1"
    write(0, "(a)"), "    3.54153815974653E+04 - Ref.: 16-1"
    write(0, "(es24.14)"), verify
end subroutine Verify_Solution

! -----------------------------------------------------------------------------

end program DAEDALUS2